    ...
    try {
        ...
        if ($r) {
            $encuesta_comercial = [
                ...
                'que_busca_tasas_competitivas'  => (int)($r['que_busca_tasas_competitivas']  ?? 0),
                'que_busca_otro'                => (int)($r['que_busca_otro']                ?? 0),
                'que_busca_otro_texto'          => (string)($r['que_busca_otro_texto']       ?? ''),
