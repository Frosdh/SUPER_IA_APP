...
try {
    ...
    if ($tiene_empresa_post === 1) {
        ...
        if ($rowN) {
            ...
            // 80 params (columnas p1_conoce_institucion..p3_obs se agregaron
            // después y quedaron 7 columnas sin su "?" correspondiente en
            // VALUES(...), causando "Column count doesn't match value count
            // at row 1" en el upsert de encuesta_negocio — ya corregido.
            $stN->bind_param(
