...
while ($row = $result->fetch_assoc()) {
    $viajes[] = [
        ...
        "origen_lat"    => $row['origen_lat'] !== null ? floatval($row['origen_lat']) : 0,
        "origen_lng"    => $row['origen_lng'] !== null ? floatval($row['origen_lng']) : 0,
        "destino_lat"   => $row['destino_lat'] !== null ? floatval($row['destino_lat']) : 0,
        "destino_lng"   => $row['destino_lng'] !== null ? floatval($row['destino_lng']) : 0,
