    ...
    if ($id_solicitud && $accion) {
        try {
            if ($accion === 'aprobar') {
                ...
                if ($solicitud) {
                    // Insertar usuario en tabla usuarios con rol Asesor (id_rol = 4)
                    // Si existe la columna supervisor_id_fk, se asigna para que el asesor quede ligado al supervisor.
                    ...
                    if ($hasSupervisorFk) {
                        $stmt = $pdo->prepare("
                            INSERT INTO usuarios (usuario, clave, nombres, apellidos, email, telefono, activo, id_rol_fk, supervisor_id_fk)
                            VALUES (?, ?, ?, ?, ?, ?, 1, 4, ?)
                        ");
...
// Obtener solicitudes de asesores (todas)
$solicitudes = [];
try {
    $query = "SELECT sa.*, CONCAT(u.nombres, ' ', u.apellidos) as nombre_supervisor
        FROM solicitudes_asesor sa
        JOIN usuarios u ON sa.id_supervisor = u.id_usuario
        ORDER BY 
            CASE sa.estado 
...
$currentPage = 'administrar_asesores';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Super_IA - Administrar Asesores</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-new { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; padding: 10px 20px; border-radius: 8px; cursor: pointer; text-decoration: none; font-weight: 600; display: flex; align-items: center; gap: 8px; }
        .btn-new:hover { transform: translateY(-2px); box-shadow: 0 5px 20px rgba(102, 126, 234, 0.4); }
...
<?php if ($is_super_admin): ?>
    <?php $currentPage = 'administrar_asesores'; require_once '_sidebar_super_admin.php'; ?>
<?php else: ?>
<!-- SIDEBAR -->
<div class="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <a href="administrar_asesores.php" class="sidebar-link active">
...
<div class="main-content">
    ...
    <div class="navbar-custom">
        <h2><?php echo $is_super_admin ? '👑' : '🎯'; ?> Super_IA - Administrar Asesores</h2>
        <div class="user-info">
            <div>
    ...
    <div class="content-area">
        ...
        <div class="page-header">
            <h1><i class="fas fa-users me-2"></i>Gestión de Asesores</h1>
            <a href="crear_asesor_admin.php" class="btn-new">
        ...
        <div class="table-card">
            <div class="card-header-custom">
                <h6><i class="fas fa-list me-2"></i>Listado de Solicitudes de Asesores</h6>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td><small><?php echo htmlspecialchars($solicitud['nombre_supervisor']); ?></small></td>
                                ...
                                <td>
                                    ...
                                    <button class="btn-aprobar" onclick="mostrarModal('aprobar', <?php echo $solicitud['id_solicitud']; ?>, '<?php echo htmlspecialchars(addslashes($solicitud['nombres'])); ?>')">
                                        <i class="fas fa-check me-1"></i>Aprobar
                                    </button>
                                    <button class="btn-rechazar" onclick="mostrarModal('rechazar', <?php echo $solicitud['id_solicitud']; ?>, '<?php echo htmlspecialchars(addslashes($solicitud['nombres'])); ?>')" style="margin-left: 5px;">
...
function mostrarModal(accion, id, nombre) {
    ...
    if (accion === 'aprobar') {
        title.textContent = 'Aprobar Solicitud de Asesor';
        ...
        title.textContent = 'Rechazar Solicitud de Asesor';
        modalHTML = '<p><strong>Asesor:</strong> ' + nombre + '</p>';
