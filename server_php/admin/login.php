...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .orb1 {
            width: 580px; height: 580px; top: -200px; right: -160px;
        ...
        .login-card {
            display: flex;
            width: 940px; max-width: 96vw; min-height: 580px;
        ...
        .form-title {
            font-size: 24px; font-weight: 900; color: #0D1929;
            letter-spacing: -.6px; margin-bottom: 4px;
        }
        .form-subtitle {
            font-size: 13px; color: #64748B; margin-bottom: 30px; line-height: 1.5;
        }

        .inp-group { margin-bottom: 16px; }
        .inp-group label {
            display: block; font-size: 11.5px; font-weight: 700;
            color: #1E3A5F; margin-bottom: 7px; letter-spacing: .3px;
            text-transform: uppercase;
        }
        .inp-wrap { position: relative; }
        .inp-wrap .ico {
            position: absolute; left: 14px; top: 50%; transform: translateY(-50%);
            color: #94A3B8; font-size: 13.5px; pointer-events: none;
        }
        .inp-wrap input {
            width: 100%; padding: 12px 42px;
            border: 1.5px solid #E2E8F0; border-radius: 11px;
            font-size: 14px; font-family: 'Inter', sans-serif;
            color: #0D1929; background: #fff;
        ...
        .btn-login {
            ...
            color: #0D1929; font-size: 15px; font-weight: 800;
            cursor: pointer; transition: transform .2s, box-shadow .2s;
            box-shadow: 0 6px 22px rgba(var(--accent-rgb),.38);
            font-family: 'Inter', sans-serif; margin-top: 8px;
            display: flex; align-items: center; justify-content: center; gap: 9px;
        }
        /* Texto oscuro o claro según rol */
        ...
        .btn-login:hover {
            ...
            box-shadow: 0 10px 30px rgba(var(--accent-rgb),.5);
        }
