...
try {
    ...
    $tables = $conexion->query("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='base_super_ia'");
    ...
    $search = $conexion->query("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='base_super_ia' AND (TABLE_NAME LIKE '%unidad%' OR TABLE_NAME LIKE '%bancaria%')");
