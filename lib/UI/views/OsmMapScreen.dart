    ...
    showModalBottomSheet(
      ...
      builder: (sheetContext) => _ConfirmacionSheet(
        ...
        onCuponAplicado: (codigo, descuento, precioFinal) {
          ...
          print('>>> [CUPOM] Guardado: $codigo, Descuento: \$${descuento.toStringAsFixed(2)}');
        },
      ),
    );
  }
    ...
    try {
      ...
      for (final contacto in contactos) {
        try {
          ...
          final telefonoFormateado = SOSService.formatearTelefonoWhatsapp(contacto.telefono);
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 24),
            Text('Compartir viaje', style: TextStyle(color: ConstantColors.textWhite, fontSize: 18, fontWeight: FontWeight.w700)),
            SizedBox(height: 20),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text('WhatsApp', style: TextStyle(color: Colors.green, fontSize: 15, fontWeight: FontWeight.w600)),
                          Text('Compartir con contacto', style: TextStyle(color: ConstantColors.textGrey, fontSize: 12)),
                        ],
                      ),
                    ),
                    Icon(Icons.arrow_forward_rounded, color: ConstantColors.textGrey, size: 20),
                  ],
                ),
              ),
            ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(color: ConstantColors.primaryBlue.withOpacity(0.3)),
                ),
                child: Row(
                  children: [
                    Icon(Icons.sms, color: ConstantColors.primaryBlue, size: 24),
                    SizedBox(width: 14),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('SMS', style: TextStyle(color: ConstantColors.primaryBlue, fontSize: 15, fontWeight: FontWeight.w600)),
                          Text('Enviar por mensaje de texto', style: TextStyle(color: ConstantColors.textGrey, fontSize: 12)),
                        ],
                      ),
                    ),
                    Icon(Icons.arrow_forward_rounded, color: ConstantColors.textGrey, size: 20),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.link, color: ConstantColors.primaryViolet, size: 24),
                    SizedBox(width: 14),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Copiar enlace', style: TextStyle(color: ConstantColors.primaryViolet, fontSize: 15, fontWeight: FontWeight.w600)),
                          Text('Copiar ubicación al portapapeles', style: TextStyle(color: ConstantColors.textGrey, fontSize: 12)),
                        ],
                      ),
                    ),
                    Icon(Icons.arrow_forward_rounded, color: ConstantColors.textGrey, size: 20),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text('Cerrar', style: TextStyle(color: ConstantColors.textWhite, fontSize: 15, fontWeight: FontWeight.w600)),
                ),
              ),
            ),
          ],
  ...
  Future<void> _compartirWhatsapp(String mensaje) async {
    try {
      ...
      await showDialog(
        ...
        builder: (_) => AlertDialog(
          backgroundColor: ConstantColors.backgroundCard,
          title: Text('Ingresa el número', style: TextStyle(color: ConstantColors.textWhite)),
          content: TextField(
        ...
        builder: (_) => AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: Text('Enviar', style: TextStyle(color: ConstantColors.primaryBlue)),
            ),
          ],
        ),
      );
  ...
  Future<void> _copiarEnlace() async {
    try {
      ...
      await showDialog(
        ...
        builder: (_) => AlertDialog(
          backgroundColor: ConstantColors.backgroundCard,
          title: Text('Enlace de ubicación', style: TextStyle(color: ConstantColors.textWhite)),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              SelectableText(
                enlace,
                style: TextStyle(color: ConstantColors.primaryBlue, fontSize: 12),
              ),
            ],
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              child: Text('Cerrar', style: TextStyle(color: ConstantColors.textGrey)),
            ),
          ],
        ),
      );
                ...
                child: AnimatedContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      Text('SOS', style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ),
  ...
  Future<void> _validarCodigo() async {
    ...
    try {
      ...
      if (!DiscountCodeService.cumpleMinimoViaje(discountCode, widget.precio)) {
        setState(() {
          _mensajeError = DiscountCodeService.obtenerMensajeMinimo(discountCode, widget.precio);
      ...
      // Calcular descuento
      final descuento = DiscountCodeService.obtenerMontoDescuento(widget.precio, discountCode);
      ...
      print('>>> [DISCOUNT] Cupón válido: $codigo, Descuento: \$${descuento.toStringAsFixed(2)}, Precio final: \$${precioFinal.toStringAsFixed(2)}');
    } catch (e) {
      if (mounted) {
        setState(() {
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Container(
          ...
          child: Row(children: [
            ...
            SizedBox(width: 12),
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(widget.origen, style: TextStyle(color: ConstantColors.textGrey, fontSize: 13),
                maxLines: 1, overflow: TextOverflow.ellipsis),
              SizedBox(height: 18),
              Text(widget.destino, style: TextStyle(color: ConstantColors.textWhite, fontSize: 14, fontWeight: FontWeight.w600),
                maxLines: 1, overflow: TextOverflow.ellipsis),
            ])),
          ]),
        ),
        ...
        Container(
          ...
          child: Row(children: [
            ...
            Container(
              ...
              child: Center(child: Text(widget.categoria.icono, style: TextStyle(fontSize: 24))),
            ),
            SizedBox(width: 14),
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(height: 4),
              Text('${widget.distanciaKm.toStringAsFixed(1)} km  ·  $widget.duracionMin min',
                style: TextStyle(color: ConstantColors.textGrey, fontSize: 12)),
            ])),
            // Precio destacado
            Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
        ...
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Text('\$${widget.categoria.tarifaBase.toStringAsFixed(2)}', style: TextStyle(color: ConstantColors.textGrey, fontSize: 12)),
          ]),
        ),
        SizedBox(height: 4),
        Padding(
          padding: EdgeInsets.symmetric(horizontal: 4),
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('Por distancia (${widget.distanciaKm.toStringAsFixed(1)} km)', style: TextStyle(color: ConstantColors.textSubtle, fontSize: 12)),
            Text('\$${(widget.categoria.precioKm * widget.distanciaKm).toStringAsFixed(2)}', style: TextStyle(color: ConstantColors.textGrey, fontSize: 12)),
          ]),
        ),
        SizedBox(height: 4),
        Padding(
          padding: EdgeInsets.symmetric(horizontal: 4),
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('Por tiempo ($widget.duracionMin min)', style: TextStyle(color: ConstantColors.textSubtle, fontSize: 12)),
            Text('\$${(widget.categoria.precioMinuto * widget.duracionMin).toStringAsFixed(2)}', style: TextStyle(color: ConstantColors.textGrey, fontSize: 12)),
          ]),
        ),
        ...
        if (_codigoActual.isEmpty) ...[
          ...
          Text('🎟️ ¿Tienes un código de descuento?', style: TextStyle(color: ConstantColors.textGrey, fontSize: 12, fontWeight: FontWeight.w600)),
          SizedBox(height: 10),
          Row(children: [
            Expanded(
              child: TextField(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: _validandoCodigo
                    ...
                    : Text('Validar', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 12)),
              ),
            ),
          ]),
          if (_mensajeError.isNotEmpty)
            Padding(
              ...
              child: Text(_mensajeError, style: TextStyle(color: Colors.red, fontSize: 11), maxLines: 2, overflow: TextOverflow.ellipsis),
            ),
        ] else ...[
          // Cupón aplicado
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('¡Código aplicado!', style: TextStyle(color: Colors.green, fontSize: 12, fontWeight: FontWeight.w600)),
                  Text(_codigoActual, style: TextStyle(color: ConstantColors.textWhite, fontSize: 13, fontWeight: FontWeight.w700)),
                ]),
              ),
              GestureDetector(
                onTap: _removerCupon,
                child: Icon(Icons.close, color: ConstantColors.textGrey, size: 20),
              ),
            ]),
          ),
        ],
        ...
        if (_descuentoActual > 0)
          Column(children: [
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 4),
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text('Descuento', style: TextStyle(color: Colors.green, fontSize: 12, fontWeight: FontWeight.w600)),
                Text('-\$${_descuentoActual.toStringAsFixed(2)}', style: TextStyle(color: Colors.green, fontSize: 12, fontWeight: FontWeight.w600)),
              ]),
            ),
            SizedBox(height: 8),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 4),
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text('Total', style: TextStyle(color: ConstantColors.primaryViolet, fontSize: 14, fontWeight: FontWeight.w700)),
                Text('\$${_calcularPrecioFinal().toStringAsFixed(2)}', style: TextStyle(color: ConstantColors.primaryViolet, fontSize: 14, fontWeight: FontWeight.w700)),
              ]),
            ),
            SizedBox(height: 8),
          ]),
