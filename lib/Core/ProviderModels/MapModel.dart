...
class MapModel extends ChangeNotifier {
  ...
  /// Verifica permisos y servicio antes de iniciar el stream.
  /// Evita el NullPointerException del plugin cuando se piden datos
  /// sin tener permisos concedidos.
  void _iniciarUbicacion() async {
    try {
      // 1. Verificar que el servicio GPS esté activo
      ...
      // 2. Verificar permisos (location 2.x devuelve bool, no PermissionStatus)
      bool hasPermission = await _location.hasPermission();
      if (!hasPermission) {
      ...
      // 4. Suscribirse al stream solo cuando los permisos están confirmados
      ...
      print("Error al iniciar ubicacion: $e");
    }
  }
  ...
  void _getUserLocation() async {
    ...
    try {
      ...
      print("Error obteniendo ubicacion inicial: $e");
    }
  }
